  ...
  return (
    <div className={`${className} flex gap-2 lg:gap-4`}>
      <button
        ...
        onClick={handleClick}
        className={`font-Outfi 1366:text-[12px] 1600:text-[14px] 1680:text-[16px] flex w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-[60px] py-[0.75rem] text-xxs font-normal transition-all duration-300 ease-out active:scale-95 xl:text-xs ${
          isBgWhite
            ? isHover
      ...
      {is2ndButton && (
        <button
          ...
          className={`font-Outfi 1366:text-[12px] 1600:text-[14px] 1680:text-[16px] group flex w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-[60px] py-[0.75rem] text-xxs font-normal transition-all duration-300 ease-out active:scale-95 xl:text-xs ${isFullWidth ? 'md:w-full' : 'md:w-[180px] xl:w-[220px]'} ${
            is2BgWhite
