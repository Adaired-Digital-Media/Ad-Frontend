  ...
  return (
    <div className={`${className} flex gap-2 lg:gap-4`}>
      <button
        ...
        onClick={handleClick}
        className={`font-Outfi flex w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-[60px] py-[0.75rem] text-xxs font-normal transition-all duration-300 ease-out active:scale-95 xl:text-xs ${
          isBgWhite
            ? isHover
