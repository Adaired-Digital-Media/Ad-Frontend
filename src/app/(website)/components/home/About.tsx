          ...
          <div className="relative mx-auto flex-1">
            ...
            >
              <Image
                ...
                width={581}
                height={554}
                className="h-[14rem] w-[14rem] rounded-lg md:h-[34.625rem] md:w-[36.313rem] lg:h-[20.625rem] lg:w-[20.313rem] xl:h-[34.625rem] xl:w-[36.313rem] 1600:mt-[2rem] 1600:h-[30rem] 1600:w-[28rem] 1680:mt-[2rem] 1680:h-[32rem] 1680:w-[30rem] 3xl:h-[34.625rem] 3xl:w-[36.313rem]"
              />
            </div>
            ...
            <Image
              ...
              width={246}
              height={136}
              className="absolute bottom-[-1.8rem] left-[-3rem] -z-10 lg:bottom-[22.75rem] lg:left-5 xl:bottom-[5.5rem] 1600:bottom-[8.5rem] 1680:bottom-[6.5rem] 3xl:bottom-[4rem]"
            />
