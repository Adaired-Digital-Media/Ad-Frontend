...
const HeroSection = () => {
  return (
    <section
      className={cn(
        `flex items-center justify-center overflow-hidden bg-[#FFF9F1]`
      )}
    >
      <SmallContainer className="relative z-[2] before:absolute before:left-[calc(100%-320px)] before:top-0 before:z-0 before:h-full before:w-full before:rounded-tl-[250px] before:bg-[#FFDCB2] before:content-[''] after:absolute after:left-[calc(100%-300px)] after:top-0 after:z-0 after:h-full after:w-[calc(100%-20px)] after:rounded-tl-[250px] after:bg-[#F39019] after:content-[''] 3xl:pb-0 3xl:pt-14">
        <TwoColumnGrid
